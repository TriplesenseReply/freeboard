...
<head>
    <meta charset="UTF-8">
    <title><?php echo $freeboard->getBoard()->getName() ?></title>
    ...
    <?php if ($freeboard->isJson($freeboard->getBoard()->getData())): ?>
    <script type="text/javascript">
        head.js("js/freeboard+plugins.ts.js",
            ...
            function(){
                ...
                { //DOM Ready
                    ...
                    var board = <?php echo $freeboard->getBoard()->getData() ?>;

                    freeboard.loadDashboard(board, function() {
...
<header id="main-header" data-bind="if:allow_edit">
    <div id="admin-bar" style="height: 215px;">
        <div id="admin-menu">
            <div id="board-tools">
                <h1 id="board-logo" class="title bordered"><?php echo $freeboard->getBoard()->getName() ?></h1>
                <div id="board-actions">
                    <ul class="board-toolbar vertical">
                        <li onclick="javascript:location.href = '/';"><i id="full-screen-icon" class="icon-folder-open icon-white"></i><label>Board List</label></li>
